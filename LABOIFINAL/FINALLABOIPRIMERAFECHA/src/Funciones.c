    ...
    if(this!=NULL&&pFunc!=NULL)
    {
    	for(int i=0;i<len-1;i++)
    	{
    		for(int j=i+1;j<len;j++)
    		{
    			...
    			if(order==1&&pFunc(priElemento,segElemento)>0)
    			{
    				ll_set(this,i,segElemento);
    				ll_set(this,j,priElemento);
    			}
    			else if(order==0&&pFunc(priElemento,segElemento)<0)
    			{
					ll_set(this,i,segElemento);
					ll_set(this,j,priElemento);
    			}
...
LinkedList* ll_filter(LinkedList* this, int (*fn)(void*,char*),char* ingresado)
{
    LinkedList* NuevaLL;
