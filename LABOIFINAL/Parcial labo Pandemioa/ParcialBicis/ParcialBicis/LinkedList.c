 ...
 *
 */
LinkedList* ll_filter(LinkedList* this, int (*pFuncFilter)(void*,char*), char * tipo)
{
    void * elemA = NULL;
    LinkedList* filterArray = NULL;
    if(this != NULL && pFuncFilter != NULL && tipo != NULL)
    {
	...
	if(this != NULL && pFunc != NULL)
	{
		...
		if(listaMap != NULL)
		{
			for(int i = 0; i < ll_len(this); i++)
			{
				...
				if(pElement != NULL)
				{
				    //agrego el elemento mappeado, a la nueva lista
